...
var FlMMLonHTML5 = function () {
    ...
    function FlMMLonHTML5(sRate, bufSize, workerURL) {
        ...
        worker.postMessage({
            type: COM_BOOT,
            sampleRate: sRate ? sRate : FlMMLonHTML5.audioCtx.sampleRate,
            bufferSize: bufSize ? bufSize : BUFFER_SIZE
        });
    ...
    extend(FlMMLonHTML5.prototype, {
        ...
        /*
        setBufferSize: function (buffersize, sampleRate) {
            BUFFER_SIZE = buffersize;
            this.worker.postMessage({
                type: COM_BOOT,
                sampleRate: sampleRate ? sampleRate : FlMMLonHTML5.audioCtx.sampleRate,
